...
public class MsgServerEncoder {
    @SuppressWarnings("unused")
    private static Logger log = LoggerFactory.getLogger(MsgServerEncoder.class);
    ...
    public static ByteBuffer encode(MsgResponse wsResponse, TioConfig tioConfig, ChannelContext channelContext) {
